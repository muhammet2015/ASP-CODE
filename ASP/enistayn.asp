...
<body>
	...
	<div id="styleright">
		...
		<img src="enistayn.jpg" width="550" height="450" style="position: absolute;left:20%; margin-top: 50px"><br>
	
		<fieldset style="position: absolute;top:15%;width: 500px;height: 400px;margin-top: 50%"  >
			<form action="comment.asp">	<textarea rows="3" cols="80" name="anas"></textarea>
				<input type="submit" name="submit" value="submit"></form>
						<%
								...
								rs.Open "SELECT name,time,comment FROM enistayn", conn
							%>
